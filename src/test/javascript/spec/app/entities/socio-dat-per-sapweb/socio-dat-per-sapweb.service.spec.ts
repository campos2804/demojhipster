...
describe('Service Tests', () => {
    ...
    describe('SocioDatPerSapweb Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SocioDatPerSapwebService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/socio-dat-pers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SocioDatPerSapweb', () => {
