...
describe('Service Tests', () => {
    ...
    describe('ModificacionSapweb Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ModificacionSapwebService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/modificacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ModificacionSapweb', () => {
