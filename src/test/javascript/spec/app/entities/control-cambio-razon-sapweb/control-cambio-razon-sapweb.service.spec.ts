...
describe('Service Tests', () => {
    ...
    describe('ControlCambioRazonSapweb Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ControlCambioRazonSapwebService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/control-cambio-razons';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ControlCambioRazonSapweb', () => {
