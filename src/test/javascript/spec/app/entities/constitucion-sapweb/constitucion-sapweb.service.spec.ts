...
describe('Service Tests', () => {
    ...
    describe('ConstitucionSapweb Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConstitucionSapwebService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/constitucions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ConstitucionSapweb', () => {
