...
describe('Service Tests', () => {
    ...
    describe('CargaSocvigSapweb Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CargaSocvigSapwebService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/carga-socvigs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CargaSocvigSapweb', () => {
